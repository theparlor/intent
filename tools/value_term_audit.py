...
# source of truth. 'dist' catches vendored bundles (e.g. forge outputs/dist/voices-panel
# vendoring the voices registry): a write-through registry lives beside its
# score-owning source, never in build output.
_EXCLUDE_DIR_PARTS = {".venv", "venv", ".worktrees", "node_modules", "__pycache__", ".git", "dist"}
