    ...
    <div>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 3 }}>
        ...
        >
          ...
          >
            <div>
              <Badge color={C.accent}>DEV OS</Badge>
              <div
                style={{
                  fontSize: 18,
                  fontWeight: 700,
      ...
      <div style={{ marginTop: 32 }}>
        ...
        >
          Dev OS occupies the intersection of
        </div>
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 10 }}>
          {[
            {
  ...
  const phases = [
    {
      ...
      items: [
        "Dev OS Manifesto — sharp, opinionated, shareable",
    ...
    },
    {
      ...
      items: [
        "Dev OS Playbook — practical guide + templates",
    ...
    },
    {
      ...
      items: [
        "Dev OS Hub — lightweight loop support layer",
...
function HypothesesSection() {
  ...
  const hypotheses = [
    ...
    },
    {
      ...
      test: "Can 5 teams sustain the Dev OS loop 3+ months using only markdown specs and Git?",
    ...
    <div>
      <div style={{ marginBottom: 32 }}>
        ...
        >
          ...
          <br />
          <span style={{ color: C.textMuted, fontWeight: 400 }}>
            Where Dev OS sits relative to existing approaches
          </span>
        </h2>
      </div>
      ...
      <Card style={{ padding: 0, overflow: "hidden" }}>
        <div style={{ position: "relative", width: "100%", height: 360 }}>
          ...
          {competitors.map((comp, i) => {
            const isDevOS = comp.name === "Dev OS";
            const isHovered = hoveredComp === i;
            const dotColor = isDevOS ? C.accent : C.textMuted;
              ...
              >
                ...
                <div
                  style={{
                    ...
                    transform: "translateX(-50%)",
                    fontSize: 11,
                    fontWeight: isDevOS ? 700 : 500,
                    color: isDevOS ? C.accent : C.textMuted,
                    whiteSpace: "nowrap",
                  }}
                >
                  {comp.name}
...
/* ═══════════════════════════════════════════
   MAIN APP
   ═══════════════════════════════════════════ */
export default function DevOSBrief() {
        ...
        >
          ...
          >
            ...
            >
              ...
              resource. Dev OS is the OS for teams with AI agents as
