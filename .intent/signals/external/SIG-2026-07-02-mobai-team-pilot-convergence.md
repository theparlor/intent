...
- [ ] **(C — critical) Build the translation layer.** Produce an executive-legible surface for Intent's core — a jargon→plain-language map + a one-page exec framing — treating MobAI's register as the style exemplar. Do NOT just borrow phrases. Tie to `SIG-2026-05-31-exposed-vocabulary-divergence-principle`: the internal↔exposed vocabulary divergence must be actively managed. (Elevated above all others by confirmed "too complex / too jargon-loaded" feedback.)
