---
title: "MobAI: From Copilot to Team Pilot — Michael Göthe (Crisp)"
type: "external-input / competitor-adjacent (team-practice articulation of AI-in-the-flow)"
related:
  - Core/frameworks/intent/spec/SPEC-INTENT-COHERENCE-GATE-001.md
  - Core/frameworks/intent/spec/SPEC-INTENT-FORMATION-FLIGHT-001.md
  - Core/frameworks/intent/spec/SPEC-INTENT-MISSION-BRIEF-001.md
  - Core/frameworks/intent/spec/team-os-alignment-annex.md
frameworks:
...
---
# MobAI: From Copilot to Team Pilot — verbatim archive

> Verbatim ingest per the raw/-is-immutable rule. Source: Crisp blog, Michael Göthe, 2026-06-18.
> Interpretation lives in `.intent/signals/external/SIG-2026-07-02-mobai-team-pilot-convergence.md`,
> not here. This file is read, never rewritten.
...
AI can make individuals faster. It can also make teams more fragmented.
...
That is the question behind MobAI: What happens when a team uses AI together on real work?
...
The shift is from asking, "How can I become faster with AI?" to asking, "How can the team use AI to think, learn, and make better decisions together?" That is the shift from Copilot to Team Pilot.

## Shared work needs deliberate conditions

That shift sounds simple, but it is not automatic. In recent MobAI work, both in course settings and in a full-day customer hackathon, one thing became clear: It is not enough to put people in a room with AI and hope collaboration happens.
...
Then the next rotation gets better. The point is not to remove humans from the loop. The point is to make the human loop better.
...
In a recent MobAI hackathon, this became very concrete. The team worked on a real product and technical challenge. We used short rotations, shared screens, frequent reflection, and AI in the flow. We also recorded the team's opening context: purpose, constraints, technical setup, and challenge framing.
...
That changed the quality of the work. Not because the AI suddenly became brilliant, but because the team had given it something better than a generic prompt: Their actual situation: purpose, constraints, language, technical context, open questions, and what they were trying to learn.
...
The team did not only give AI a better starting point. It kept improving the context as the work unfolded. That is where the real work begins.
...
That could look like a problem. I think it was part of the value. The team was not just producing AI-assisted output. It was discovering what it needed to clarify in order to make better progress.

This is why I do not see MobAI as an AI training format. At least not mainly. It is a team practice.

## Why this matters now

Many organizations are treating AI as an individual productivity story. That story is useful, but too small.
...
In uncertain work, the first useful backlog may not be a list of features. It may be a list of risks and assumptions to validate. MobAI can help make that visible.

## From Copilot to Team Pilot

MobAI is not one person doing clever prompting for the group. It is not people silently using separate AI assistants in the same room. It is not an AI tool rollout. And it is not a promise that AI will solve the hard parts of collaboration. If anything, it assumes the opposite.
...
The next step is not only better individual copilots. It is better team practices. Practices where AI is visible in the work. Where the team owns the output. Where human judgment stays in the loop. Where context improves over time. Where people learn together, not only faster apart.

That is why I find MobAI interesting. Not because it is a new label for using AI, but because it points to a deeper shift:
